...
class PwaGenerationService : Service() {
    ...
    companion object {
        ...
        const val ACTION_GENERATION_COMPLETE = "com.toymakerftw.mothership.GENERATION_COMPLETE"
        const val EXTRA_PWA_NAME = "pwa_name"
        const val EXTRA_SUCCESS = "success"
        const val EXTRA_ERROR_MESSAGE = "error_message"

        private const val ACTION_START_GENERATION = "com.toymakerftw.mothership.START_GENERATION"
        private const val ACTION_STOP_SERVICE = "com.toymakerftw.mothership.STOP_SERVICE"
